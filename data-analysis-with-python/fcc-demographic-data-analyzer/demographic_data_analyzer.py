...
def calculate_demographic_data(print_data=True):
    ...
    race_count = []
    for race in races:
        race_count.append(df[df["race"] == race].shape[0])
    ...
    rich_percentage = df[
        ...
        (df["salary"] == ">50K")
    ].shape[0] * 100 / num_min_workers
    rich_percentage = round(rich_percentage, 1)

    # What country has the highest percentage of people that earn >50K?
    highest_earning_country_df =  df[df["salary"] == ">50K"]["native-country"].value_counts() * 100 / df["native-country"].value_counts()
    highest_earning_country = highest_earning_country_df.idxmax()
    highest_earning_country_percentage = highest_earning_country_df.max()
